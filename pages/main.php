         ...
         <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li>
                    ...
                    <li><a href="?menu=edit" <?php if($menu == "edit"){echo 'class="active alert-danger"';} ?>><i class="fa fa-gear fa-fw"></i> แก้ไขข้อมูลการจองรถตู้</a></li>
                     <li class="divider"></li>

                    <li><a href="?menu=delete" <?php if($menu == "delete"){echo 'class="active alert-danger"';} ?>><i class="fa fa-gear fa-fw"></i> ลบข้อมูลการจองรถตู้</a></li> 
